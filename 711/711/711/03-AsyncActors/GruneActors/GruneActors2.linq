...
async Task MainAsync() {
    ...
    input.LinkTo(grune_ab, new DataflowLinkOptions{PropagateCompletion = true,});
    //grune_ab.LinkTo(print, new DataflowLinkOptions{PropagateCompletion = true,});
    grune_ab.LinkTo(grune_bc, new DataflowLinkOptions{PropagateCompletion = true,});
    grune_bc.LinkTo(print, new DataflowLinkOptions{PropagateCompletion = true,});
